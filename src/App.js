...
import MyApp from "./components/playround";
import MyApp1 from "./components/playround/datetime";
      ...
      <div className="App">
        <BrowserRouter>
          ...
          <Switch>
            ...
            <Route path='/nhap' component={MyApp} />

            <Route path='/nhap1' component={MyApp1} />
